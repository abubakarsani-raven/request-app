    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Store requests and inventory management
        </p>
      </div>
        ...
        {metrics.store && (
          <>
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold">{metrics.store.totalItems || 0}</div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold text-orange-600">{metrics.store.lowStockItems || 0}</div>
              </CardContent>
            </Card>
          </>
        )}
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="text-2xl font-bold">{metrics.requests.byType.STORE.total || 0}</div>
              </div>
              <div>
                <div className="text-sm text-muted-foreground">Pending</div>
                <div className="text-2xl font-bold">{metrics.requests.byType.STORE.pending || 0}</div>
              </div>
            </div>
          </CardContent>
        </Card>
