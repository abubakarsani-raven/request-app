...
class ICTRequestHistoryPage extends StatefulWidget {
  const ICTRequestHistoryPage({Key? key}) : super(key: key);

  @override
  State<ICTRequestHistoryPage> createState() => _ICTRequestHistoryPageState();
}
...
class _ICTRequestHistoryPageState extends State<ICTRequestHistoryPage> {
  ...
  Participant? _getUserParticipant(ICTRequestModel request) {
                  ...
                  () {
                    ...
                    if (_controller.historyRequests.isEmpty) {
                      return EmptyState(
                        ...
                        message: 'You haven\'t participated in any ICT requests yet.',
  ...
  Widget _buildRequestCard(BuildContext context, ICTRequestModel request, Participant? participant) {
    final theme = Theme.of(context);
    final isDark = theme.brightness == Brightness.dark;
