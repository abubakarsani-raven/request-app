...
class StoreRequestHistoryPage extends StatefulWidget {
  ...
  @override
  State<StoreRequestHistoryPage> createState() => _StoreRequestHistoryPageState();
}
...
class _StoreRequestHistoryPageState extends State<StoreRequestHistoryPage> {
  ...
  Participant? _getUserParticipant(StoreRequestModel request) {
                  ...
                  () {
                    ...
                    if (_controller.historyRequests.isEmpty) {
                      return EmptyState(
                        ...
                        message: 'You haven\'t participated in any store requests yet.',
                        icon: AppIcons.store,
  ...
  Widget _buildRequestCard(BuildContext context, StoreRequestModel request, Participant? participant) {
    final theme = Theme.of(context);
    final isDark = theme.brightness == Brightness.dark;
